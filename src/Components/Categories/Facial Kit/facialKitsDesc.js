...
<div>
  ...
  <p>Revitalize your skin with the Kalonji Brightening Facial Kit 6-in-1, a comprehensive skincare regimen designed to enhance your skin’s natural glow and even out skin tone. This kit harnesses the potent benefits of kalonji oil (black seed oil), renowned for its powerful antioxidant and anti-inflammatory properties that nourish and protect the skin.</p>
  ...
  <ul class="list-disc ml-6 pl-4">
    ...
    <li><strong>Mask:</strong> A nourishing face mask infused with kalonji oil to rejuvenate and hydrate the skin, leaving it feeling soft and supple.</li>
    <li><strong>Serum:</strong> A concentrated serum that targets dark spots and pigmentation, promoting a brighter and more radiant complexion.</li>
    <li><strong>Moisturizer:</strong> A hydrating moisturizer that locks in moisture, ensuring your skin stays soft, hydrated, and glowing throughout the day.</li>
  ...
  <ul class="list-disc ml-6 pl-4">
    ...
    <li>Rich in Antioxidants: The kalonji oil helps fight free radicals and protect the skin from environmental stressors.</li>
    <li>Deeply Nourishing: Each product is designed to hydrate and nourish, leaving the skin soft and supple.</li>
...
const   DrRaheelWiteningRiceFacialDesc = `
<p><strong>Product Type:</strong> Facial Kit</p>
<p><strong>Material:</strong> Cream</p>
<p><strong>Package Includes:</strong> 1 x Scrub, 1 x Mask, 1 x Face Wash</p>
...
<ul className="list-disc ml-6 pl-4">
  ...
  <li><strong>Anti-Aging Benefits:</strong> Includes glycolic peel to gently exfoliate and remove dead skin cells, promoting a smoother texture and reducing the appearance of fine lines and wrinkles.</li>
...
<p>Achieve a brighter, more radiant complexion with the Whitening and Glowing Facial Kit, your go-to solution for a natural, youthful glow.</p>
`;

const FruityWhiteningFacialDesc = `
<p><strong>Product Type:</strong> Facial Treatment</p>
<p><strong>Material:</strong> Cream</p>
<p><strong>Volume:</strong> 75 ml</p>
<p><strong>Package Includes:</strong> 1 x Fruity Whitening Urgent Facial Tube</p>
...
<ul className="list-disc ml-6 pl-4">
  ...
  <li><strong>Complete Facial Treatment:</strong> Offers a comprehensive solution for a refreshed and rejuvenated complexion, ideal for those needing immediate results.</li>
...
const DermaWhiteningAndBrighteningDesc = `
<p><strong>Product Type:</strong> Facial Kit</p>
<p><strong>Material:</strong> Cream</p>
<p><strong>Texture:</strong> Smooth</p>
<p><strong>Weight:</strong> 200 g</p>
<p><strong>Package Includes:</strong> 1 x Facial Kit</p>
...
<ul className="list-disc ml-6 pl-4">
  ...
  <li><strong>Smooth Texture:</strong> Features a creamy, smooth texture that glides effortlessly over the skin for a comfortable and effective treatment.</li>
  <li><strong>Suitable for All Skin Types:</strong> Gentle enough for daily use and appropriate for normal, oily, dry, combination, and sensitive skin.</li>
...
const GlutaponeFKDesc = `
<p><strong>Product Type:</strong> Facial Kit</p>
<p><strong>Material:</strong> Liquid</p>
<p><strong>Pack Size:</strong> Pack of 6</p>

<h2>Package Includes:</h2>
<ul className="list-disc ml-6 pl-4">
  <li>1 x Glutapone Facial Face Wash, 180 ml</li>
  <li>1 x Glutapone Facial Cleanser, 180 ml</li>
  <li>1 x Glutapone Facial Skin Polish, 180 ml</li>
  <li>1 x Glutapone Facial Scrub, 180 ml</li>
  <li>1 x Glutapone Facial Massage Cream, 180 ml</li>
  <li>1 x Glutapone Facial Mask, 180 ml</li>
</ul>
...
<ul className="list-disc ml-6 pl-4">
  ...
  <li><strong>Hydrating and Nourishing:</strong> Each product is designed to provide hydration and nourishment, leaving your skin feeling refreshed and revitalized.</li>
  <li><strong>Smooth Texture:</strong> Features a smooth, liquid texture for easy application and effective results.</li>
...
<ul className="list-disc ml-6 pl-4">
  ...
  <li><strong>Skin Polish:</strong> Apply a small amount to damp skin, massaging gently. Rinse thoroughly with water.</li>
  <li><strong>Scrub:</strong> Gently massage onto damp skin, focusing on areas prone to dullness. Rinse well.</li>
  <li><strong>Massage Cream:</strong> Apply to face and neck, massaging gently in upward strokes. Leave on for a few minutes, then rinse off.</li>
  <li><strong>Mask:</strong> Apply evenly to face, avoiding the eye area. Leave on for the recommended time, then rinse off with lukewarm water.</li>
</ul>

<p>Achieve a brighter, more even complexion with the Whitening Facial Kit, Pack of 6, your all-in-one solution for radiant and healthy skin.</p>

`;

const SkinTouchGoldDesc = `
<p><strong>Product Type:</strong> Facial</p>
<p><strong>Package Includes:</strong> 1 x Facial</p>
...
<ul className="list-disc ml-6 pl-4">
  ...
  <li><strong>Brightening:</strong> Enhances your skin's natural radiance, leaving it looking fresh, luminous, and rejuvenated.</li>
...
const TeaTreeOrganicSkincareKitDesc = `
<p><strong>Product Type:</strong> Skincare Kit</p>
<p><strong>Package Includes:</strong> 1 x Skincare Kit</p>
...
<ul className="list-disc ml-6 pl-4">
  ...
  <li><strong>Gentle and Effective:</strong> Ideal for all skin types, including sensitive skin, and designed to provide a balance of gentle care and powerful results.</li>
...
const BNBFacialKitDesc = `
<p><strong>Product Type:</strong> Facial Kit</p>
<p><strong>Material:</strong> Cream</p>

<h2>Package Includes:</h2>
<ul className="list-disc ml-6 pl-4">
  <li>Whitening Face Wash</li>
  <li>Whitening Facial Cleanser</li>
  <li>Whitening Facial Scrub</li>
  <li>Whitening Facial Polish</li>
  <li>Whitening Facial Massage Cream</li>
  <li>Whitening Face Mask</li>
</ul>
...
<ul className="list-disc ml-6 pl-4">
  ...
  <li><strong>Brightening and Whitening:</strong> Formulated to brighten and lighten the skin, helping to reduce the appearance of dark spots and uneven skin tone.</li>
...
<ul className="list-disc ml-6 pl-4">
  ...
  <li><strong>Whitening Facial Scrub:</strong> Exfoliates dead skin cells and impurities, promoting a smoother, more radiant complexion.</li>
  <li><strong>Whitening Facial Polish:</strong> Polishes the skin, helping to improve texture and enhance brightness.</li>
  <li><strong>Whitening Facial Massage Cream:</strong> Nourishes and rejuvenates the skin while providing a soothing massage experience.</li>
...
<ul className="list-disc ml-6 pl-4">
  ...
  <li><strong>Scrub:</strong> Apply a small amount to damp skin, massage gently, and rinse thoroughly.</li>
  <li><strong>Polish:</strong> Apply to clean skin, massage gently, and rinse off.</li>
  <li><strong>Massage Cream:</strong> Apply to face and neck, massage gently, and leave on for a few minutes before rinsing.</li>
  <li><strong>Face Mask:</strong> Apply evenly to the face, avoid the eye area, leave on for the recommended time, and rinse off.</li>
</ul>

<p>Achieve a brighter, more glowing complexion with the Rice Whitening and Glowing Facial Kit, your all-in-one solution for radiant and youthful skin.</p>

`;

const riceCleaningScrubDesc = `
<p><strong>Product Type:</strong> Facial Scrub</p>
<p><strong>Material:</strong> Cream</p>
<p><strong>Size:</strong> 100 ml</p>
<p><strong>Package Includes:</strong> 1 x Facial Scrub</p>
...
<ul className="list-disc ml-6 pl-4">
  ...
  <li><strong>For All Skin Types:</strong> Suitable for normal, oily, dry, combination, and sensitive skin, making it a versatile addition to any skincare routine.</li>
...
const nourishingFacialKitDesc = `
<p><strong>Product Type:</strong> Facial Kit</p>
<p><strong>Material:</strong> Cream</p>
<p><strong>Texture:</strong> Smooth</p>
<p><strong>Color:</strong> White</p>
<p><strong>Product Features:</strong> Nourishing, Rejuvenating, Glowing</p>
<p><strong>Package Includes:</strong></p>
<ul className="list-disc ml-6 pl-4">
    <li>1 x Facial Scrub</li>
    <li>1 x Face Mud Mask</li>
    <li>1 x Face Massage Cream</li>
    <li>1 x Skin Polisher</li>
    <li>1 x Double Action Treatment</li>
    <li>1 x Triple Action Treatment</li>
</ul>
...
<ul className="list-disc ml-6 pl-4">
    ...
    <li><strong>Complete Facial Regimen:</strong> Includes a full suite of products—facial scrub, face mud mask, face massage cream, skin polisher, double action, and triple action treatments—ensuring a thorough and effective skincare routine.</li>
...
<ul className="list-disc ml-6 pl-4">
    ...
    <li><strong>Face Massage Cream:</strong> Nourishes and massages the skin, enhancing relaxation and improving texture.</li>
    <li><strong>Skin Polisher:</strong> Smooths and refines the skin's surface, enhancing brightness and radiance.</li>
    <li><strong>Double Action Treatment:</strong> Offers targeted treatment for specific skin concerns, combining effective ingredients for optimal results.</li>
...
<ul className="list-disc ml-6 pl-4">
    ...
    <li><strong>Face Massage Cream:</strong> Apply to face and neck, massage gently in upward strokes until fully absorbed.</li>
    <li><strong>Skin Polisher:</strong> Apply to clean, dry skin, and gently polish in circular motions. Rinse off with water.</li>
    <li><strong>Double Action Treatment:</strong> Follow the instructions for targeted treatment application.</li>
    <li><strong>Triple Action Treatment:</strong> Apply as directed for intensive treatment, following the recommended usage guidelines.</li>
</ul>

<p>Achieve a nourished, rejuvenated, and glowing complexion with the Nourishing Facial Kit - Pack of 6, your all-in-one solution for radiant and healthy skin.</p>
`;


const TheOdinaryFacialKitDesc = `
<p><strong>Product Type:</strong> Skincare Kit</p>
<p><strong>Material:</strong> Cream</p>
<p><strong>Package Includes:</strong> 4 x Brightening Glow Kit</p>
...
<ul className="list-disc ml-6 pl-4">
    ...
    <li><strong>Hydration and Brightening:</strong> Hydrates the skin while enhancing brightness, leaving your complexion refreshed and glowing.</li>
...
<ul className="list-disc ml-6 pl-4">
    ...
    <li><strong>Hydrating Cream:</strong> Apply to face and neck, massaging gently until fully absorbed. Use daily as part of your skincare routine.</li>
</ul>

<p>Achieve a glowing, even-toned complexion with the Brightening Glow Kit - Pack of 4, your essential solution for radiant and revitalized skin.</p>

`;

const BrighteningFacialKitBNBDesc = `
<p><strong>Product Type:</strong> Facial Kit</p>
<p><strong>Material:</strong> Cream</p>
<p><strong>Texture:</strong> Smooth</p>
<p><strong>Color:</strong> Pink</p>
<p><strong>Number of Pieces:</strong> 3</p>
<p><strong>Product Features:</strong> Whitening and Brightening, Exfoliator, Nourishing</p>
...
<ul className="list-disc ml-6 pl-4">
    ...
    <li><strong>Nourishing:</strong> Enriched with nourishing ingredients to hydrate and revitalize the skin, enhancing overall texture and health.</li>
...
<ul className="list-disc ml-6 pl-4">
    ...
    <li><strong>Nourishing Moisturizer:</strong> Apply to face and neck, massaging gently until fully absorbed. Use daily for optimal hydration and nourishment.</li>
</ul>

<p>Achieve a brighter, more radiant complexion with the Brightening Facial Kit, your all-in-one solution for a glowing and revitalized appearance.</p>

`;

export {kalonjiFKDesc, DrRaheelWiteningRiceFacialDesc, FruityWhiteningFacialDesc , DermaWhiteningAndBrighteningDesc , GlutaponeFKDesc, SkinTouchGoldDesc , TeaTreeOrganicSkincareKitDesc, BNBFacialKitDesc, riceCleaningScrubDesc, nourishingFacialKitDesc, 
  TheOdinaryFacialKitDesc , BrighteningFacialKitBNBDesc
}