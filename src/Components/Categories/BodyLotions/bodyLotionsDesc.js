...
<p><strong>Product Type:</strong> Exfoliating Scrub</p>
  ...
  <ul className="list-disc ml-6 pl-4">
    ...
    <li><strong>Frequency:</strong> For best results, use the scrub twice a day as part of your daily skincare routine.</li>
  </ul>

  <h3>Description:</h3>
  <p>Unleash the power of natural ingredients with our Face & Body Plant Energy Scrub. This cream-based scrub is specially designed to exfoliate and remove dead skin cells, revealing a brighter and more refreshed complexion. Its unique blend of plant extracts provides energy and vitality to the skin, making it an essential part of your skincare regimen. Perfect for use on both the face and body, this scrub ensures a deep cleanse, leaving your skin soft, smooth, and rejuvenated.</p>

  <p>Get glowing, healthy skin with the Face & Body Plant Energy Scrub — your go-to solution for exfoliation and skin renewal!</p>
`;
...
<p><strong>Product Type:</strong> Body Lotion</p>
  ...
  <ul className="list-disc ml-6 pl-4">
    ...
    <li><strong>Gentle and Soothing:</strong> Ideal for sensitive skin, this lotion helps to soothe and calm, ensuring comfort throughout the day.</li>
  </ul>
  ...
  <p>Keep your skin hydrated and healthy with our Hydrating Body Lotion — a perfect addition to your daily skincare routine.</p>
`;
...
<p><strong>Product Type:</strong> Heel Cream</p>
  ...
  <ul className="list-disc ml-6 pl-4">
    ...
    <li><strong>Use Daily:</strong> For best results, apply twice daily, in the morning and at night, or as needed.</li>
  </ul>

  <p>Transform your skin with Soapex Heel Cream — your go-to solution for soft, smooth, and healthy feet and hands.</p>
`;
...
<p><strong>Product Type:</strong> Foot & Hand Scrub</p>
  ...
  <ul className="list-disc ml-6 pl-4">
    ...
    <li><strong>Skin Revitalization:</strong> Improves the overall texture and appearance of the skin, providing a healthy and glowing look.</li>
  </ul>
  ...
  <h3>Description:</h3>
  <p>Elevate your skincare routine with the Dead Skin Remover Foot & Hand Scrub, a must-have for those seeking soft, smooth, and revitalized skin. This scrub is formulated with natural ingredients that deeply cleanse and gently exfoliate, effectively removing dead skin cells and calluses from your feet and hands. The result? Healthy, glowing skin that feels refreshed and rejuvenated.</p>
  ...
  <ul className="list-disc ml-6 pl-4">
    ...
    <li><strong>Protect:</strong> Apply the free sunblock to exposed areas to shield your skin from UV damage.</li>
  </ul>
