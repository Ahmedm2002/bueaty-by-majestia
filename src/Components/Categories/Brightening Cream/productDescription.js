...
<ul className="list-disc ml-6 pl-4">
  ...
  <li className="mb-2">Suitable for All Skin Types</li>
  <li className="mb-2">Export Quality</li>
...
<ul className="list-disc ml-6 pl-4">
  ...
  <li className="mb-2"><strong>Sun Protection:</strong> SPF 45 provides broad-spectrum protection against UVA and UVB rays, preventing sunburn and premature aging.</li>
  <li className="mb-2"><strong>Suitable for All Skin Types:</strong> Formulated to be gentle and effective for normal, oily, dry, combination, and sensitive skin.</li>
...
<ol>
  ...
  <li className="mb-2">Massage gently into the skin in upward circular motions until fully absorbed.</li>
...
<ul className="list-disc ml-6 pl-4">
  ...
  <li className="mb-2"><strong>Skin Rejuvenation:</strong> Enhances skin texture, leaving it smoother and softer.</li>
  <li className="mb-2"><strong>Herbal Ingredients:</strong> Utilizes natural herbs that are gentle on the skin while providing effective results.</li>
...
<ol>
  ...
  <li className="mb-2">Gently massage in circular motions to help the product penetrate and exfoliate the skin.</li>
  <li className="mb-2">Leave it on for a few minutes, then rinse off with lukewarm water.</li>
...
<ul className="list-disc ml-6 pl-4">
  ...
  <li className="mb-2">Avoid direct sun exposure immediately after use, or apply sunscreen if heading outdoors.</li>
</ul>
`;
...
<ul className="list-disc ml-6 pl-4">
  ...
  <li className="mb-2">Offers protection from sunlight</li>
  <li className="mb-2">Rejuvenates skin, leaving it soft and radiant</li>
</ul>
...
<ul className="list-disc ml-6 pl-4">
  ...
  <li className="mb-2"><strong>Rejuvenating Touch:</strong> Infused with natural herbs and fruits that help to refresh and revitalize the skin.</li>
  <li className="mb-2"><strong>Suitable for All Skin Types:</strong> Gentle enough for daily use on any skin type, including sensitive skin.</li>
...
<ol>
  ...
  <li className="mb-2">Massage gently in upward circular motions until fully absorbed.</li>
...
<ul className="list-disc ml-6 pl-4">
  ...
  <li className="mb-2">Store in a cool, dry place to maintain the cream’s effectiveness.</li>
</ul>
`;
...
<ul className="list-disc ml-6 pl-4">
  ...
  <li className="mb-2">Color: Yellow</li>
</ul>
...
<ul className="list-disc ml-6 pl-4">
  ...
  <li className="mb-2"><strong>Moisturizing Effect:</strong> Hydrates and conditions skin and hair, promoting a healthy and radiant appearance.</li>
...
<ol>
  ...
  <li className="mb-2">Massage in a circular motion until fully absorbed.</li>
  <li className="mb-2">Use before bedtime to allow the oil to work overnight for maximum benefits.</li>
</ol>

<p><strong>For Hair:</strong></p>
<ol>
  <li className="mb-2">Open a capsule and mix the oil with your regular conditioner or apply it directly to your scalp.</li>
  <li className="mb-2">Massage gently and leave it on for a few minutes before rinsing thoroughly.</li>
...
<ul className="list-disc ml-6 pl-4">
  ...
  <li className="mb-2">Always perform a patch test before applying the oil directly to the skin to check for any potential allergic reactions.</li>
</ul>
`;
...
<ul className="list-disc ml-6 pl-4">
  ...
  <li className="mb-2"><strong>Smooths Texture:</strong> Helps to smooth out rough patches and uneven skin texture.</li>
...
<ol>
  ...
  <li className="mb-2"><strong>Rinse:</strong> Rinse off with lukewarm water and pat your skin dry.</li>
...
<ul className="list-disc ml-6 pl-4">
  ...
  <li className="mb-2">Avoid using on irritated or broken skin.</li>
</ul>
`;
...
<ul className="list-disc ml-6 pl-4">
  ...
  <li className="mb-2"><strong>Minimizes Scars:</strong> Helps to diminish the appearance of acne scars.</li>
...
<ol>
  ...
  <li className="mb-2"><strong>Massage:</strong> Gently massage until fully absorbed.</li>
...
<ul className="list-disc ml-6 pl-4">
  ...
  <li className="mb-2"><strong>Moisturizing:</strong> Provides a smooth and soft texture to the skin.</li>
...
<ol>
  ...
  <li className="mb-2"><strong>Massage:</strong> Gently massage in upward strokes until fully absorbed.</li>
...
<ul className="list-disc ml-6 pl-4">
  ...
  <li className="mb-2">Brightening</li>
</ul>
...
<ol>
  ...
  <li className="mb-2"><strong>Massage:</strong> Gently massage in circular motions for best results.</li>
  <li className="mb-2"><strong>Leave On:</strong> Allow it to stay on for the recommended time as per the product instructions.</li>
...
<ol>
  ...
  <li className="mb-2"><strong>Massage:</strong> Gently apply and massage the product evenly over your face in circular motions.</li>
  <li className="mb-2"><strong>Leave On:</strong> Follow the instructions for how long to leave it on for optimal results.</li>
...
<ol>
  ...
  <li className="mb-2"><strong>Massage:</strong> Use upward, circular motions to ensure even coverage.</li>
...
<ol>
  ...
  <li className="mb-2"><strong>Massage:</strong> Gently massage in upward circular motions.</li>
...
<ol>
  ...
  <li className="mb-2"><strong>Apply Brightener:</strong> Follow with the Dust Free Facial Blond Brightener.</li>
...
<ul className="list-disc ml-6 pl-4">
  ...
  <li className="mb-2">Use regularly for best results and a radiant complexion.</li>
</ul>
`;
...
<ol>
  ...
  <li className="mb-2"><strong>Leave On:</strong> Allow the cream to absorb and remain on the skin.</li>
...
<ul className="list-disc ml-6 pl-4">
  ...
  <li className="mb-2">If irritation occurs, discontinue use and consult a dermatologist.</li>
</ul>
`;
...
<ul className="list-disc ml-6 pl-4">
  ...
  <li className="mb-2"><strong>Acne and Cracks:</strong> Assists in fighting acne and repairing skin cracks.</li>
...
<ol>
  ...
  <li className="mb-2"><strong>Absorb:</strong> Allow the cream to fully absorb into the skin.</li>
...
<ul className="list-disc ml-6 pl-4">
    ...
    <li className="mb-2"><strong>Strengthens the Skin Barrier:</strong> Helps to fortify the skin's natural barrier, enhancing its resilience against environmental stressors.</li>
    <li className="mb-2"><strong>Moisturizing:</strong> Delivers deep hydration, keeping the skin soft and supple.</li>
...
<ul className="list-disc ml-6 pl-4">
    ...
    <li className="mb-2"><strong>Enhances Skin Texture:</strong> Designed to improve skin texture, this cream provides a smoother, softer feel. The massaging action helps stimulate blood circulation, which can further enhance skin health and appearance.</li>
...
<ul className="list-disc ml-6 pl-4">
    ...
    <li className="mb-2"><strong>Hydration and Nourishment:</strong> Rich in moisturizing agents, this cream provides deep hydration to the skin, ensuring it remains soft, supple, and well-nourished. Well-hydrated skin is essential for the healing process and overall skin health.</li>
...
SaeedGhaniFootAndHandCreamDesc,VitaminCCream60gDesc,GlupatoneBCDesc, FacialBeautyCreamDesc, WhiteningEmulsionDesc, SkinPolish300gDesc, CentellaCream30GDesc, VitaminCWhiteningCreamDesc, goldenPearlMassageCreamDesc, AcneRemovalCreamDesc
}