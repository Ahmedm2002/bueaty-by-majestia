const DeepFreshFaceWashDesc = `
<p><strong>Product Type:</strong> Brightening Face Wash</p>
<p><strong>Material:</strong> Face Wash</p>
<p><strong>Weight:</strong> 75 g</p>
<p><strong>Package Includes:</strong> 1 x Brightening Face Wash</p>
...
<ul className="list-disc ml-6 pl-4">
  ...
  <li><strong>Rejuvenating Touch:</strong> Enriched with ingredients that promote a soft, smooth texture, helping to maintain a youthful and glowing appearance.</li>
  <li><strong>Suitable for All Skin Types:</strong> Gentle enough for daily use, making it ideal for all skin types, including sensitive skin.</li>
</ul>

<h3><strong>How to Use:</h3></strong>
<p>Apply a small amount of face wash to damp skin, gently massaging in circular motions. Rinse thoroughly with lukewarm water and pat dry. Use morning and evening for best results.</p>
<p>Experience a brighter, more radiant complexion with the Deep Fresh Brightening Face Wash, your go-to solution for glowing, healthy skin.</p>

`;

const GalipWashScrubMaskDesc = `
<p><strong>Product Type:</strong> Face & Body Scrubbing Mask</p>
<p><strong>Material:</strong> Cream</p>
<p><strong>Weight:</strong> 170 g</p>
...
<ul className="list-disc ml-6 pl-4">
  ...
  <li><strong>Deep Cleansing:</strong> Cleanses deeply to remove dirt, oil, and other impurities, leaving your skin feeling refreshed and rejuvenated.</li>
  <li><strong>Hydrating and Nourishing:</strong> Infused with moisturizing ingredients to ensure your skin stays hydrated and soft after use.</li>
</ul>

<h3><strong>How to Use:</h3></strong>
<p>Apply a generous amount to damp skin, gently massaging in circular motions. For the face, avoid the eye area. Leave on for a few minutes to let the mask work its magic, then rinse thoroughly with lukewarm water. Use 2-3 times a week for best results.</p>
<p>Reveal smoother, glowing skin with the 3 in 1 Face & Body Scrubbing Mask, your all-in-one solution for a revitalizing skincare routine.</p>

`;

const RiceFaceWashDesc = `
<p><strong>Product Type:</strong> Face Wash</p>
<p><strong>Material:</strong> Liquid</p>
<p><strong>Texture:</strong> Smooth</p>
<p><strong>Volume:</strong> 120 ml</p>
<p><strong>Skin Types:</strong> Normal, Oily, Dry, Combination, Sensitive, Acne-Prone</p>
<p><strong>Product Feature:</strong> Hydrating, Absorbent</p>
<p><strong>Package Includes:</strong> 1 x Face Wash</p>
...
<ul className="list-disc ml-6 pl-4">
  ...
  <li><strong>Absorbent:</strong> Effectively removes impurities, excess oil, and dirt, while allowing the skin to retain its natural balance.</li>
  <li><strong>Nourishing Ingredients:</strong> Infused with rice extract to provide additional soothing and revitalizing benefits, helping to maintain a healthy, radiant complexion.</li>
</ul>

<h3><strong>How to Use:</h3></strong>
<p>Apply a small amount to damp skin, gently massaging in circular motions. Rinse thoroughly with lukewarm water and pat dry. Use morning and evening for best results.</p>
<p>Enjoy a refreshing and hydrating cleanse with the Rice Face Wash, perfect for maintaining a balanced and healthy complexion.</p>
`;

const GoldernPearlTripleProtectionDesc = `
<p><strong>Product Type:</strong> Sunblock</p>
<p><strong>Material:</strong> Skin Care Product</p>
<p><strong>Finish-Type:</strong> Skin Care</p>
<p><strong>Weight:</strong> 200 g</p>
<p><strong>Product Dimensions:</strong> L5 x W2 x H3 (inches)</p>
<p><strong>Package Includes:</strong> 1 x Sunblock</p>
<p><strong>Product Warranty:</strong> 100% Original</p>
...
<h3><strong><strong>Key Features:</strong></h3></strong>
<ul className="list-disc ml-6 pl-4">
  ...
  <li><strong>Easy Application:</strong> Smooth and easy to apply, ensuring thorough coverage on all exposed areas for optimal sun protection.</li>
  <li><strong>Original Product:</strong> Guaranteed to be 100% original, ensuring you receive high-quality sun protection.</li>
</ul>

<h3><strong><strong>How to Use:</strong></h3></strong>
<p>Apply a sufficient amount of sunblock to cover all exposed areas of your skin, including areas such as the ears, neck, back of the hands, and tops of the feet. For best results, apply at least 15 to 30 minutes before sun exposure to allow the sunscreen to bind properly to your skin. Reapply every two hours or after swimming, sweating, or towel drying.</p>
<p>Protect your skin with confidence using Sunblock Triple Protection, your go-to solution for comprehensive and reliable sun defense.</p>
`

const DrRashelFaceWashDesc = `
<p><strong>Product Type:</strong> Face Wash</p>
<p><strong>Material:</strong> Liquid</p>
<p><strong>Volume:</strong> 100 g</p>
<p><strong>Package Includes:</strong> 1 x Face Wash</p>
...
<ul className="list-disc ml-6 pl-4">
  ...
  <li><strong>Preventative Care:</strong> Formulated to help prevent acne and blemishes by keeping pores clear and reducing excess oil.</li>
  <li><strong>Daily Use:</strong> Gentle enough for everyday use, making it a perfect addition to your daily skincare routine.</li>
</ul>

<h3><strong>How to Use:</h3></strong>
<p>Apply a small amount of the face wash to damp skin, gently massaging in circular motions. Rinse thoroughly with lukewarm water and pat dry. Use morning and evening for best results.</p>
<p>Achieve clearer, healthier skin with Dr. Rashel's Purifying Face Wash, your go-to solution for a refreshed and rejuvenated complexion.</p>
`;

const AcneControlTeaDesc = `
<p><strong>Product Type:</strong> Face Wash</p>
<p><strong>Material:</strong> Liquid</p>
<p><strong>Package Includes:</strong> 1 x Face Wash</p>
...
<ul className="list-disc ml-6 pl-4">
  ...
  <li><strong>Refreshing Cleanse:</strong> Provides a refreshing and invigorating cleanse that leaves the skin feeling clean, balanced, and revitalized.</li>
  <li><strong>Daily Use:</strong> Suitable for daily use, making it a valuable addition to your regular skincare regimen.</li>
</ul>

<h3><strong>How to Use:</h3></strong>
<p>Apply a small amount of the face wash to damp skin, massaging gently in circular motions. Rinse thoroughly with lukewarm water and pat dry. Use morning and evening for best results.</p>
<p>Achieve clearer, healthier skin with Acne Control Tea Tree Face Wash, your essential tool for fighting acne and maintaining a fresh, blemish-free complexion.</p>

`;

const SQMBlackHeadClearingDesc = `
<p><strong>Product Type:</strong> Scrub</p>
<p><strong>Material:</strong> Cream</p>
<p><strong>Weight:</strong> 170 g</p>
<p><strong>Package Includes:</strong> 1 x Blackhead Clearing Oil-Free Salicylic Acid Aloe Scrub</p>
...
<ul className="list-disc ml-6 pl-4">
  ...
  <li><strong>Tan Removal:</strong> Helps to address and reduce the appearance of tans and uneven skin tone, promoting a more uniform and radiant complexion.</li>
  <li><strong>Refining Action:</strong> Uncovers the skin's natural brightness, contributing to a younger-looking appearance with regular use.</li>
</ul>

<h3><strong>How to Use:</h3></strong>
<p>Apply a small amount of scrub to damp skin, gently massaging in circular motions. Focus on areas prone to blackheads or dullness. Rinse thoroughly with lukewarm water and pat dry. Use 2-3 times a week for best results.</p>
<p>Reveal clearer, brighter skin with the Blackhead Clearing Oil-Free Salicylic Acid Aloe Scrub, your essential tool for a revitalized and radiant complexion.</p>

`;


export {DeepFreshFaceWashDesc , GalipWashScrubMaskDesc , RiceFaceWashDesc , GoldernPearlTripleProtectionDesc, DrRashelFaceWashDesc , AcneControlTeaDesc , SQMBlackHeadClearingDesc}