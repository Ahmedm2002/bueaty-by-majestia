...
const allProducts = [
  ...bodyLotionsArr, ...BrighteningCreamsArr, ...CleansersArr, ...FaceWashArr, ...FacialKitsArr, ...GelsArr, ...FaceMasksArr, ...NightCreamsArr, ...powdersArr, ...serumsArr, ...sunblocksArr, ...tonersArr
]
